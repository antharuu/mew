...
use crate::properties::{Property, color, size, display, font, border};
use crate::values::*;
use std::fmt;
...
impl Style {
    ...
    pub fn text_align(&mut self, value: &str) -> &mut Self {
    ...
    pub fn border_style(&mut self, value: &str) -> &mut Self {
